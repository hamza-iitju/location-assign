...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Admin', 'middleware' => ['auth']], function () {
    ...
    // Location-assign
    Route::delete('locations/destroy', 'LocationAssignController@massDestroy')->name('locations.massDestroy');
    Route::get('locations/show-all', 'LocationAssignController@allLocations')->name('locations.show-all');
    Route::resource('locations', 'LocationAssignController');
